        ...
        <aside className="hidden flex-col justify-between border-r border-[color:var(--border)] bg-[linear-gradient(180deg,rgba(110,91,255,0.08),rgba(81,196,255,0.08),rgba(70,208,123,0.06))] px-8 py-8 lg:flex xl:px-10">
          ...
          <div className="max-w-md">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-tight text-[color:var(--foreground-strong)]">
              Find real opportunities, keep your profile ready, and apply with confidence.
            </h2>
            <p className="mt-4 text-sm leading-7 text-[color:var(--foreground-muted)]">
              Use one account to manage saved jobs, your resume, and the organizations you follow.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              "Save jobs and organizations",
              "Build a stronger job-seeker profile",
            ].map((item) => (
              <div
                key={item}
